...
public class DateTimeTest {
    ...
    public void should_convert_list_and_array_to_list_of_long(){
        ...
        assertThat(Types.LIST_DATETIME.convert(new Date[]{new Date(190000)}), is(Collections.singletonList(new Date(190000).toInstant())));
        assertThat(Types.LIST_DATETIME.convert(new DateList(new Date(190000))), is(Collections.singletonList(new Date(190000).toInstant())));
        assertThat(Types.LIST_DATETIME.convert(new Instant[]{new Date(190000).toInstant()}), is(Collections.singletonList(new Date(190000).toInstant())));
        assertThat(Types.LIST_DATETIME.convert(new InstantList(new Date(190000).toInstant())), is(Collections.singletonList(new Date(190000).toInstant())));
